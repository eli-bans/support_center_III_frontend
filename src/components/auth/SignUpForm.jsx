    ...
    <div className="signup-container">
      <div className="signup-form">
        ...
        <div className="input-group">
          ...
          <div className="input-wrapper">
            <FaKey className="input-icon" />
            <input type={showConfirmPassword ? "text" : "password"} id="confirm-password" placeholder="Confirm your password" />
            <button className="toggle-password" onClick={() => setShowConfirmPassword(!showConfirmPassword)}>
              {showConfirmPassword ? <FaEye className="eye-icon" /> : <FaEyeSlash className="eye-icon" />}
            </button>
          </div>
        </div>
